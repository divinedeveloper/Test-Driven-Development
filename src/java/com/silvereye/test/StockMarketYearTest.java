...
public class StockMarketYearTest {
	...
	public void interestEarned() {
		...
		assertEquals("withdrawals dont earn interest", new Dollars(800), year.interestEarned());
		year.withdraw(new Dollars(2000));
		assertEquals("capital gains tax withdrawals dont earn interest", new Dollars(566), year.interestEarned());
	}
	...
	@Test
	public void testNextYearStartingValuesMatchesThisYearEndingValues() {
